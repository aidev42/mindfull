angular.module('Mindfilled').controller('HistoryController', function($scope, UserService, $ionicActionSheet, $state, $ionicLoading, $localStorage, $http, moment){
  ...
  $scope.edit = function(activity){
    $localStorage.editActivity = activity
    $state.go("app.edit")
  }
